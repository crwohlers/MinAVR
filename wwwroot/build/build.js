...
define("main", ["require", "exports", "lib/arduino-blink", "lib/avr8js/index", "interopManager"], function (require, exports, arduino_blink_1, avr8js, interopManager_1) {
    ...
    const listeners = [{
            localId: 1, listen: (e) => __awaiter(void 0, void 0, void 0, function* () {
                yield DotNet.invokeMethodAsync("MinAVR", "sendSignal", 1, { type: "int", target: "bool", data: portD.portConfig, data2: e });
            })
        }];
